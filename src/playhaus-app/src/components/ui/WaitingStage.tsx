...
interface Props {
    // Whose colours the wait is drawn in.
    game: Game,
    message: string,
    title: string
}
...
// A screen with nothing to do but wait: the game's tile breathing, what is being waited for, and three hopping dots.
export default function WaitingStage({ game, message, title }: Props) {
    const t = useT();
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.dots} accessibilityRole='progressbar' accessibilityLabel={t('lobby.waitingLabel')}>
