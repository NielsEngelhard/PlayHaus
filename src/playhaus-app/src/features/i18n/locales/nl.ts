    ...
    oneOfUs: {
        ...
        play: {
            ...
            discuss: {
                ...
                description: 'Wijs allemaal tegelijk naar wie je niet vertrouwt. Wie de meeste stemmen heeft, ligt eruit. Niet stemmen mag niet.',
                tieNote: 'Niet verdedigen, niet overleggen. Gewoon stemmen!',
                tieNoteMayor: 'Niet verdedigen, niet overleggen. Gewoon stemmen! Bij gelijkspel beslist {{name}} als burgemeester.',
                action: 'Stemmen'
            },
            vote: {
                title: 'Wie moet eruit?',
