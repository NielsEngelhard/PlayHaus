...
import TableSetupHelp from "@/features/pubquizr/components/table/TableSetupHelp";
import { screenUrl } from "@/features/screen/screen-url";
import { createThemedStyles } from "@/features/theme/createThemedStyles";
import { useRouter, type Href, type RelativePathString } from "expo-router";
import { useState } from "react";
import { View } from "react-native";

interface Props {
    /** Where the arrow goes, which differs between the game's own door and the short one a remote types. */
    backHref: Href
}
